...
conference = Conference(
        ...
        begin_date = datetime.date(YEAR, 5, 17),
        end_date = datetime.date(YEAR, 5, 25)
)
...
## ----------------------------------------------------------------------------
url = 'https://us.pycon.org/2017/sponsors/'
...
## Volunteers
url = 'https://us.pycon.org/2017/about/staff/'
xpath = '//div[@class="box"]/*'
...
keynotes = (
    ...
    (['Katy Huff'], 'Do it for Science', ['University of Illinois'], 'http://pyvideo.org/pycon-us-2017/.html', ['JOSS', 'community']),
    (['Lisa Guo', 'Hui Ding'], 'Python @ Instagram', ['Instagram'], 'http://pyvideo.org/pycon-us-2017/.html', ['Python 3', 'Python 2', 'Django']),
    (['Jake Vanderplas'], 'The unexpected effectiveness of Python in science', ['University of Washington'], 'http://pyvideo.org/pycon-us-2017/.html', ['Jupyter', 'astronomy', 'science', 'reproducibility', 'community']),
)
...
def add_presentation(url, category):
    ...
    for i in range(int((len(entries)-first) / 3)):
        ...
        if 'canceled' in title.lower():
            continue
        speakers = p.text_content().strip().split(',')
...
url = 'https://us.pycon.org/2017/schedule/tutorials/'
add_presentation_from_table(url, Talk.TUTORIAL)

url = 'https://us.pycon.org/2017/schedule/sponsor-tutorials/'
add_presentation_from_table(url, Talk.TUTORIAL)


url = 'https://us.pycon.org/2017/schedule/talks/'
add_presentation_from_table(url, talk.TALK)

url = 'https://us.pycon.org/2017/schedule/posters/list/'
